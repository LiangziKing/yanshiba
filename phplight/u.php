...
<table class="info tablex2">
  ...
  <tr>
    <td class="er">MariaDB Client组件</td>
...
?>
  <tr>
    <td colspan="2" class="er">MariaDB <?=$_POST['mysqlHost']?></td>
